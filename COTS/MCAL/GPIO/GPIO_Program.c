...
switch (Port){
case GPIO_PORTA:SET_BIT(GPIO_PORTA_DEN,pin); break;
case GPIO_PORTB:SET_BIT(GPIO_PORTB_DEN,pin);break;
case GPIO_PORTC:SET_BIT(GPIO_PORTC_DEN,pin);break;
case GPIO_PORTD:SET_BIT(GPIO_PORTD_DEN,pin);break;
case GPIO_PORTE:SET_BIT(GPIO_PORTE_DEN,pin);break;
