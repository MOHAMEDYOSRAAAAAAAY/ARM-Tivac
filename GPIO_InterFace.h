...
#define	GPIO_PORTB_DATA_MASK (*((volatile u32 *)(0x40059000+ 0x598 )))
#define	GPIO_PORTC_DATA_MASK (*((volatile u32 *)(0x4005A000+ 0x598 )))
#define	GPIO_PORTD_DATA_MASK (*((volatile u32 *)(0x4005B000+ 0x598 )))
#define	GPIO_PORTE_DATA_MASK (*((volatile u32 *)(0x4005C000+ 0x598 )))
#define GPIO_PORTF_DATA_MASK	(*((volatile u32 *)(0x400253FC)))	
	
#define GPIO_PORTA_CR	(*((volatile u32 *)(0x40058524)))
#define GPIO_PORTB_CR	(*((volatile u32 *)(0x40059524)))
#define GPIO_PORTC_CR	(*((volatile u32 *)(0x4005A524)))
#define GPIO_PORTD_CR	(*((volatile u32 *)(0x4005B524)))
#define GPIO_PORTE_CR	(*((volatile u32 *)(0x4005C524)))
#define GPIO_PORTF_CR	(*((volatile u32 *)(0x40025524)))
	

#define	GPIO_PORTA_LOCK (*((volatile u32 *)(0x40058000+ 0x520 )))
#define	GPIO_PORTB_LOCK (*((volatile u32 *)(0x40059000+ 0x520 )))
#define	GPIO_PORTC_LOCK (*((volatile u32 *)(0x4005A000+ 0x520 )))
#define	GPIO_PORTD_LOCK (*((volatile u32 *)(0x4005B000+ 0x520 )))
#define	GPIO_PORTE_LOCK (*((volatile u32 *)(0x4005C000+ 0x520 )))
#define GPIO_PORTF_LOCK	(*((volatile u32 *)(0x40025000+ 0x520 )))
